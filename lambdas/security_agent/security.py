"""Security Agent Lambda handler — thin wrapper over validator_runner."""
...
from security_prompts import SYSTEM_PROMPT, build_user_prompt
...
@instrument_agent("security_agent")
def lambda_handler(
    event: dict[str, Any],
    context: Any,
    ...
    try:
        return run_validator(
            ...
            item_type_prefix="SECURITY",
            ready_status="SECURITY_READY",
            failed_status="SECURITY_FAILED",
            report_filename="security.json",
        ...
        logger.exception("security_unhandled_error")
        return {
